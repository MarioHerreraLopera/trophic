...
#'
#' @param x An input matrix created with the n.matrix function or a data matrix of prey abundance.
#' @param it For matrices generated with n.matrix, MUST be equal to columns matrix number.
